...
// define the "SPI_IOC_MESSAGE" struct type
var SPI_IOC_MESSAGE = StructType({
    c_iflag : ref.types.uint64, //tx_buf
    c_oflag : ref.types.uint64, //rx_buf
    c_cflag : ref.types.uint32, //len
    c_lflag : ref.types.uint32, //speed_hz
    c_lflag : ref.types.uint16, //delay_usecs
    c_lflag : ref.types.uint8, //bits_per_word
    c_lflag : ref.types.uint8, //cs_change
    c_lflag : ref.types.uint32 //pad
});
