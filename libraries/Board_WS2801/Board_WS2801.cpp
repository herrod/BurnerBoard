...
//
// Starting at 0,0 left to right, top to bottom
//    Back
// ----**----    
// --******--
// --******--
...
// Emulate a 70 x 10 matrix
// Strip sizes are 31, 45, 60, 66, 70, 70, 66, 60, 45, 31
// col1: 1-19, 20-50, 51-70: 20-50->1-31
// col2: 71-140: 71-82, 83-127, 128-140: 83-127->32-76 
// col3: 141-210: 141-145, 146-205, 206-210: 146-205->77-136
// col4: 211-280: 211-212, 213->278, 279-280: 213-278->137-202
// col5: 281-350: 281-350: 281-350->203-272
// col6: 351-420: 351-420: 351-420->273-342
// col7: 421-490: 421-422, 423-488, 489-490: 423-488->343-408
// col8: 491-560: 491-495, 496-555, 556-560: 496-555->409-468
// col9: 561-630: 561-572, 573-617, 618-630: 573-617->469-513
// col10: 631-700: 631-649, 650-680, 681-700: 650-680->514-544
uint32_t Board_WS2801::BoardPixel(uint32_t pixel) {
  uint32_t newpixel;
  ...
  //2 83-127->32-76
  if (pixel >= 83 && pixel <= 127)
    newpixel = pixel - 83 + 32;
  //3 146-205->77-136
  if (pixel >= 146 && pixel <= 205)
    newpixel = pixel - 146 + 77;
  //4 213-278->137-202
  if (pixel >= 213 && pixel <= 278)
    newpixel = pixel - 213  + 137;
  //5 281-350->203-272
  if (pixel >= 281 && pixel <= 350)
    newpixel = pixel - 281 + 203;
  //6 351-420->273-342
  if (pixel >= 351 && pixel <=420)
    newpixel = pixel - 351 + 273;
  //7 423-488->343-408
  if (pixel >= 423 && pixel <= 488)
    newpixel = pixel - 423 + 343;
  //8 496-555->409-468
  if (pixel >= 496 && pixel <= 555)
    newpixel = pixel - 496 + 409;
  //9 573-617->469-513
  if (pixel >= 573 && pixel <= 617)
    newpixel = pixel - 573 + 469;
  //10 650-680->514-544
  if (pixel >= 650 && pixel <= 680)
    newpixel = pixel - 650 + 514;
